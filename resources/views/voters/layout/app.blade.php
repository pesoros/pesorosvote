<html>
    <head>
        ...
        <link href="{{ asset('adminassets/libs/alertify.js/css/alertify.css') }}" rel="stylesheet" type="text/css">
    ...
    <body data-layout="horizontal">
        ...
        <script src="{{ asset('adminassets/libs/alertify.js/js/alertify.js') }}"></script>
